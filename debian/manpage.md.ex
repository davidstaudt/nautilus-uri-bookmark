% nautilus-uri-bookmark(SECTION) | User Commands
%
% "December  3 2024"
...
nautilus-uri-bookmark - program to do something

# SYNOPSIS

**nautilus-uri-bookmark** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**nautilus-uri-bookmark** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **nautilus-uri-bookmark** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**nautilus-uri-bookmark** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    nautilus-uri-bookmark. See **foo.conf**(5) for further details.
...
**nautilus-uri-bookmark** provides some return codes, that can be used in scripts:
...
David Staudt <dstaudt@usa.net>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 David Staudt
